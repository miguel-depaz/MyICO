...
contract ReleasableMyCoin is ReleasableToken, MyCoin {
    ...
    constructor(uint256 _initialSupply) public MyCoin(_initialSupply) {}

    function release() public onlyOwner {
        released = true;
    }

    function transfer(address _to, uint256 _amount) public canTransfer {
...
contract MyCrowdsale is Ownable {
    ...
    event Refund(address payable investor, uint256 value); //added payable keyword
        ...
        returns (bool)
    {
        ...
        //bool withinCrowdsalePeriod = true; //Enable for quick testing purposes
    ...
    function finalize() public onlyOwner {
        ...
        //bool isCrowdsaleComplete = true; //Enable for quick testing purposes
    ...
    function refund() public {
        ...
        address payable investor = msg.sender; //added payable keyword
...
contract TranchePricingCrowdsale is MyCrowdsale {
    struct Tranche {
    ...
    constructor(
        ...
        public
        payable
        MyCrowdsale(_startTime, _endTime, 1, _etherInvestmentObjective)
    {
...
contract FixedPricingCrowdsale is MyCrowdsale {
    constructor(
        uint256 _startTime,
        uint256 _endTime,
        uint256 _weiTokenPrice,
